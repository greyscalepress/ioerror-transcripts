...
So this is not a problem with Tor, it’s a problem with Firefox. Our build of Firefox, so this is why we release security updates. They were able to connect back to an FBI server. This is a pretty amazing thing, that we actually caused an exploit in the wild. We work really hard to stop this kind of stuff. 
